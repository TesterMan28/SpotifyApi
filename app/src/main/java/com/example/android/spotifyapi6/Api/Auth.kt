...
/**
 * Shared class used by Youtube services. Contains methods for authorizing a user and caching credentials.
 * Credits to : https://github.com/htchien/youtube-api-samples-kotlin/blob/master/src/main/kotlin/tw/htchien/youtube/api/Auth.kt
 */
object Auth {
    ...
    fun authorize(scopes: List<String>, credentialDatastore: String): Credential {
        ...
        // Check that the defaults have been replaced (Default = "Enter X here").
